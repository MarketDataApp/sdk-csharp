...
|----|--------|---------|--------|
| ubuntu-latest | PASS | PASS | run 32516092418 |
| windows-latest | PASS | PASS | run 32516092418 |
| macos-latest | PASS | PASS | run 32516092418 |

## GitHub Actions Status

```
CI on main @ 31e11d7 — completed/success
...
Its evidence for this release comes from PR #88 (run 32515931454, 21/21 passed) and it
