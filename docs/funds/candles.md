...
The same date-window rules as [stock candles](../stocks/candles.md) apply and are validated before any HTTP call.
...
For CSV output, call `client.Funds.GetCandlesCsvAsync(...)` and read `.Csv`. See [Settings](../settings.md#csv-output).
